...
<!-- bespoke diagram: edit diagrams/entity-relationship-diagram.mmd or .hints.json, then: npx pict-renderer-graph build modules/utility/retold-sample-data/docs -->
![Entity Relationship Diagram](diagrams/entity-relationship-diagram.svg)
